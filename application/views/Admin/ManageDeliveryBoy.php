...
<body class="navbar-fixed sidebar-fixed" id="body">
				...
				<div class="content"><!-- For Components documentaion -->
					...
					<div class="card card-default">
						<div class="card-header">
							...
							<a class="btn mdi mdi-plus mdi-24px" data-toggle="modal" data-target="#add-plan">Add new</a>
						</div>
	...
	<!-- add planModel  -->
	<div class="modal fade" id="add-plan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered " role="document">
			<div class="modal-content">
				<form action="<?= base_url('Admin/ManageDeliveryBoy/Add') ?>" method="POST">
					<div class="modal-header px-4">
						<h5 class="modal-title" id="exampleModalCenterTitle">Add Delivary Boy</h5>
					</div>
					<div class="modal-body px-4">
						<div class="row mb-2">
							<div class="col-lg-12">
								<div class="form-group">
									<label for="palnName">Name</label>
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" placeholder="Enter Aadhar Number"
										name="aadhar" minlength="10" maxlength="14" required="">
								</div>
							</div>
						</div>
					</div>
