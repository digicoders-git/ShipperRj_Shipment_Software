				...
				<div class="content d-flex justify-content-center align-items-center"
					...
					<div class="change-password-card p-5 animate-up">
						<div class="text-center">
							...
							<p class="text-muted mb-5">Update your administrator password to maintain portal security.
							</p>
						</div>

						<form action="<?= base_url('Admin/ChangePasswordAction') ?>" method="POST">
							<div class="mb-4">
								<label class="form-label fw-bold text-dark small text-uppercase">Old Password</label>
							...
							<button type="submit" class="btn btn-submit">
								Change Password <i class="mdi mdi-arrow-right ms-2"></i>
							</button>
						</form>
					</div>
				</div>
