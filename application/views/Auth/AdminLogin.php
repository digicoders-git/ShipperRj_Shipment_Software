	...
	<div class="login-wrapper">
		<div class="login-card">
			<div class="logo-area">
				...
				<div class="portal-badge">Administrative Gate</div>
				<h2>Admin Portal</h2>
				<p class="subtitle">Secure access to management dashboard</p>
			</div>

			<form action="<?= base_url('Auth/AdminAuthentication') ?>" method="POST">
				<div class="form-group">
					<label class="form-label">Email Address</label>
					<input type="email" class="form-control" name="email" placeholder="admin@shipperrj.com" required
						autocomplete="email">
				</div>
				...
				<div class="form-group">
					...
					<div class="password-toggle-wrapper">
						...
						<span class="toggle-password" onclick="togglePasswordVisibility('adminPassword', this)">
			...
			<div class="footer-text">
				Protected by ShipperRJ Secure Gate. <br>
