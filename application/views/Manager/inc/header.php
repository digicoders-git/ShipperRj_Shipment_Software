...
<header class="main-header" id="header">
	<nav class="navbar navbar-expand-lg navbar-light" id="navbar">
		...
		<div class="d-none d-xl-flex align-items-center mx-auto text-dark clock-wrapper"
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user-menu">
					<button class="dropdown-toggle nav-link" data-toggle="dropdown">
						...
						<span class="d-none d-lg-inline-block">Courier</span>
					</button>
					<ul class="dropdown-menu dropdown-menu-right">
						<li>
							<a class="dropdown-link-item" href="<?= base_url('Manager/SecuritySettings') ?>">
						...
						<li>
							<a class="dropdown-link-item" href="javascript:void(0)"
								onclick="LogoutConfirm('<?= base_url('Manager/LogOut') ?>')">
