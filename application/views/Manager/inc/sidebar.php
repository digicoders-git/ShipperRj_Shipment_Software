...
<aside class="left-sidebar sidebar-dark" id="left-sidebar">
    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="app-brand justify-content-center">
            <a href="<?= base_url('Manager/index') ?>"
                ...
                <img src="<?= base_url('assets/web_assets/img/gallery/logo.png') ?>" alt="Logo"
                    style="height: 45px; width: auto; max-width: 100%; object-fit: contain; margin-right: 25px;">
            </a>
        </div>
        ...
        <div class="sidebar-left" data-simplebar="" style="height: calc(100% - 150px);">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                <li class="<?= $segment2 == 'index' ? 'active' : '' ?>">
                    <a class="sidenav-item-link" href="<?= base_url('Manager/index') ?>">
                        <i class="mdi mdi-view-dashboard-outline"></i>
                        <span class="nav-text">Manager Dashboard</span>
                    </a>
                </li>
                <li class="<?= $segment2 == 'ManageBooking' ? 'active' : '' ?>">
                    <a class="sidenav-item-link" href="<?= base_url('Manager/ManageBooking') ?>">
                        <i class="mdi mdi-package-variant"></i>
                        <span class="nav-text">Manage Bookings</span>
                    </a>
                </li>
                <li class="<?= $segment2 == 'ManageDeliveryBoy' ? 'active' : '' ?>">
                    <a class="sidenav-item-link" href="<?= base_url('Manager/ManageDeliveryBoy') ?>">
                        <i class="mdi mdi-truck-delivery"></i> <span class="nav-text">Delivery Boys</span>
                    </a>
                </li>
                <li class="<?= $segment2 == 'SecuritySettings' ? 'active' : '' ?>">
                    <a class="sidenav-item-link" href="<?= base_url('Manager/SecuritySettings') ?>">
        ...
        <div class="sidebar-footer">
            <a href="javascript:void(0)" onclick="LogoutConfirm('<?= base_url('Manager/LogOut') ?>')"
                class="logout-btn">
