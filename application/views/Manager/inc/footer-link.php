...
<script>
    ...
    function EditUser(id) {
        ...
        $("#EditModal .modal-body").load("<?php echo base_url('Manager/ManageUser/Edit/') ?>" + id);
    }
    ...
    function EditDeliveryBoy(id) {
        $("#EditModal").modal("show");
        $("#EditModal .modal-body").html("<center><i class='fa fa-2x fa-spin fa-spinner'></i></center>");
        $("#EditModal .modal-body").load("<?php echo base_url('Manager/ManageDeliveryBoy/Edit/') ?>" + id);
    }

    function AssignDelvieryBoy(id) {
        $("#EditModal").modal("show");
        $("#EditModal .modal-body").html("<center><i class='fa fa-2x fa-spin fa-spinner'></i></center>");
        $("#EditModal .modal-body").load("<?php echo base_url('Manager/ManageBooking/Edit/') ?>" + id);
    }
    ...
    function Delete(table, id) {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: "<?php echo base_url("Manager/Deletedata"); ?>",
                    type: "post",
                    data: {
                        'table': table,
                        'id': id
    ...
    function Status(e, table, where_column, where_value, column, value) {
        ...
        if (check) {
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "<?php echo base_url("Manager/UpdateStatus"); ?>",
                        type: "post",
                        data: {
                            'table': table,
                            'column': column,
